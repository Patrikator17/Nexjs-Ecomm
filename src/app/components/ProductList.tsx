  ...
  return (
        <div className="mt-12 flex gap-x-8 gap-y-16 justify-start flex-wrap">
            {res.items.map((product:products.Product) => (
                <Link href={"/"+product.slug} className="w-full sm:w-[48%] lg:w-[23%]"> 
                    ...
                    <button className="rounded-2xl ring-1 ring-cartRed text-cartRed w-max py-2 px-4 text-xs hover:bg-cartRed hover:text-white mt-4">Add to Cart</button>
                </Link>
            ))}
        </div>
    )
